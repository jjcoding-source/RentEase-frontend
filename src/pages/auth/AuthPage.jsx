...
const ROLES = [
  {
    key: 'Renter', label: 'Renter', sub: 'Find homes',
    bg: '#dbeafe', icon: (
  ...
  {
    key: 'Owner', label: 'Owner', sub: 'List property',
    bg: '#dcfce7', icon: (
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
  ...
  {
    key: 'Admin', label: 'Admin', sub: 'Manage all',
    bg: '#fce7f3', icon: (
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
    ...
    <div className="min-h-screen bg-[#f2f3ff] flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-2xl border border-[#e2e8f0] overflow-hidden grid grid-cols-2 shadow-sm">
        ...
        <div className="bg-[#eef4ff] p-12 flex flex-col justify-between">
          <div className="text-[20px] font-bold text-[#1558c0]">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {['4,200+ verified listings','Zero brokerage fees','Instant booking confirmation','Secure JWT authentication'].map(f => (
                <div key={f} className="flex items-center gap-2.5">
                  ...
                  <span className="text-[13px] text-[#334155] font-medium">{f}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {tab === 'login' && (
            <form onSubmit={handleLogin}>
              ...
              <div className="text-[12px] text-[#94a3b8] text-center mt-4">
                ...
                <span className="text-[#1558c0] font-semibold cursor-pointer"
...
function Field({ label, children }) {
  return (
    <div className="mb-3.5">
      ...
      <div className="[&_input]:w-full [&_input]:border [&_input]:border-[#e2e8f0] [&_input]:rounded-lg [&_input]:px-3.5 [&_input]:py-2.5 [&_input]:text-[14px] [&_input]:text-[#1e293b] [&_input]:outline-none [&_input:focus]:border-[#1558c0] [&_input]:font-[inherit]">
        {children}
      </div>
    </div>
  )
