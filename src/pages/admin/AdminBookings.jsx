...
export default function AdminBookings() {
  ...
  const totalRevenue = bookings
    ...
    .reduce((sum, b) => sum + (b.rent || 0) * (b.duration || 0), 0)
          ...
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#e6e7f4] flex-wrap gap-2">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <div className="flex items-center gap-2 bg-[#f2f3ff] border border-[#e6e7f4] rounded-lg px-3 py-1.5">
                ...
                <input
                  className="bg-transparent text-[12px] outline-none w-64 placeholder:text-gray-400"
                  ...
                  >
                    <td className="px-4 py-3.5">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <div className="text-[12px] font-semibold text-[#191b24] leading-snug truncate">
                            {b.propertyTitle}
                          </div>
                    ...
                    <td className="px-4 py-3.5 text-[11px] text-[#64748b]">
                      {b.moveIn ? new Date(b.moveIn).toLocaleDateString('en-IN', {
                        month: 'short',
                        day: 'numeric',
                        year: 'numeric'
                      }) : '—'}
                      <br />
                      {b.moveOut ? new Date(b.moveOut).toLocaleDateString('en-IN', {
                        month: 'short',
                        day: 'numeric',
                        year: 'numeric'
                      }) : '—'}
                    ...
                    <td className="px-4 py-3.5">
                      <Badge 
                        label={b.status} 
                        variant={STATUS_BADGE[b.status] || 'gray'} 
                      />
                    </td>
                  </tr>
                ))}
